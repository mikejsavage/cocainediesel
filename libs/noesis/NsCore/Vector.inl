...
template<typename T, unsigned N> T* begin(Vector<T, N>& v) { return v.Begin(); }
template<typename T, unsigned N> const T* begin(const Vector<T, N>& v) { return v.Begin(); }
template<typename T, unsigned N> T* end(Vector<T, N>& v) { return v.End(); }
template<typename T, unsigned N> const T* end(const Vector<T, N>& v) { return v.End(); }
