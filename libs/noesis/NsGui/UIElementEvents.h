...
struct ManipulationStartingEventArgs: public InputEventArgs
{
    ...
    ManipulationStartingEventArgs(BaseComponent* source, const RoutedEvent* event, Visual* container);
};
...
struct ManipulationInertiaStartingEventArgs: public InputEventArgs
{
    ...
    mutable InertiaRotationBehavior rotationBehavior = { FLT_NAN };

    /// The rate of slowdown of expansion inertial movement
    mutable InertiaExpansionBehavior expansionBehavior = { FLT_NAN };

    /// The rate of slowdown of linear inertial movement
    mutable InertiaTranslationBehavior translationBehavior = { FLT_NAN };
