...
inline const Matrix3 operator*(const Matrix3& m0, const Transform2& m1)
{
    ...
    res[0] = Vector3(m0[0][0] * m1[0][0] + m0[0][1] * m1[1][0] + m0[0][2] * m1[2][0],
                      m0[0][0] * m1[0][1] + m0[0][1] * m1[1][1] + m0[0][2] * m1[2][1],
                      m0[0][2]);
                    
    res[1] = Vector3(m0[1][0] * m1[0][0] + m0[1][1] * m1[1][0] + m0[1][2] * m1[2][0],
                      m0[1][0] * m1[0][1] + m0[1][1] * m1[1][1] + m0[1][2] * m1[2][1],
                      m0[1][2]);
                       
    res[2] = Vector3(m0[2][0] * m1[0][0] + m0[2][1] * m1[1][0] + m0[2][2] * m1[2][0],
...
inline Transform3& Transform3::operator*=(const Transform3& m)
{
    ...
    mVal[3] = Vector3(mVal[3][0] * m[0][0] + mVal[3][1] * m[1][0] + mVal[3][2] * m[2][0] + 
        m[3][0],
