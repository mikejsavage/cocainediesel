...
#define GLSL_SHADER_COMMON_DRAWFLAT             GLSL_BIT( 9 )
#define GLSL_SHADER_COMMON_FOG                  GLSL_BIT( 10 )

#define GLSL_SHADER_COMMON_AUTOSPRITE           GLSL_BIT( 11 )
#define GLSL_SHADER_COMMON_AUTOSPRITE2          GLSL_BIT( 12 )

#define GLSL_SHADER_COMMON_INSTANCED_TRANSFORMS GLSL_BIT( 13 )
#define GLSL_SHADER_COMMON_INSTANCED_ATTRIB_TRANSFORMS  GLSL_BIT( 14 )

#define GLSL_SHADER_COMMON_SOFT_PARTICLE        GLSL_BIT( 15 )

#define GLSL_SHADER_COMMON_AFUNC_GT0            GLSL_BIT( 16 )
#define GLSL_SHADER_COMMON_AFUNC_LT128          GLSL_BIT( 17 )
#define GLSL_SHADER_COMMON_AFUNC_GE128          ( GLSL_SHADER_COMMON_AFUNC_GT0 | GLSL_SHADER_COMMON_AFUNC_LT128 )

#define GLSL_SHADER_COMMON_FRAGMENT_HIGHP       GLSL_BIT( 18 )
