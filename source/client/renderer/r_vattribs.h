...
enum {
	...
	VATTRIB_JOINTSINDICES,
	VATTRIB_JOINTSWEIGHTS,
...
enum {
	...
	VATTRIB_JOINTSINDICES_BIT = VATTRIB_BIT( 9 ),
	VATTRIB_JOINTSWEIGHTS_BIT = VATTRIB_BIT( 10 ),

	VATTRIB_JOINTS_BITS = VATTRIB_JOINTSINDICES_BIT | VATTRIB_JOINTSWEIGHTS_BIT,

	VATTRIB_INSTANCE_QUAT_BIT = VATTRIB_BIT( 11 ),
	VATTRIB_INSTANCE_XYZS_BIT = VATTRIB_BIT( 12 ),
