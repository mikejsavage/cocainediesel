...
enum {
	...
	VATTRIB_JOINTSINDICES_BIT = VATTRIB_BIT( 7 ),
	VATTRIB_JOINTSWEIGHTS_BIT = VATTRIB_BIT( 8 ),

	VATTRIB_JOINTS_BITS = VATTRIB_JOINTSINDICES_BIT | VATTRIB_JOINTSWEIGHTS_BIT,

	VATTRIB_INSTANCE_QUAT_BIT = VATTRIB_BIT( 9 ),
	VATTRIB_INSTANCE_XYZS_BIT = VATTRIB_BIT( 10 ),
