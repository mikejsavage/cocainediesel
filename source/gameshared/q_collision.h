...
enum SolidBits : u8 {
	...
	Solid_PlayerClip = ( 1 << 2 ),
	Solid_WeaponClip = ( 1 << 3 ),
	Solid_Wallbangable = ( 1 << 4 ),
	Solid_Ladder = ( 1 << 5 ),
	Solid_Trigger = ( 1 << 6 ),
...
constexpr SolidBits SolidMask_AnySolid = SolidBits( Solid_World | Solid_PlayerClip | Solid_WeaponClip | Solid_Wallbangable );
